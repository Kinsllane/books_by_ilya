 ...
 * @property {'user' | 'admin'} role - Роль пользователя в системе (обычный пользователь или администратор).
 * @property {string} [avatarUrl] - URL изображения аватара пользователя (опционально).
 * @property {string} [bio] - Краткое описание пользователя (биография, опционально).
 */
export interface UserProfile {
    ...
    role: 'user' | 'admin';
    avatarUrl?: string; // <-- НОВОЕ ПОЛЕ: URL аватара
    bio?: string;       // <-- НОВОЕ ПОЛЕ: Биография
}
